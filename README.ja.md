...
チャンクの順位を整えるリランカー（reranker）です。公開モデル `BAAI/bge-reranker-v2-m3` の本体
重みは凍結したまま、韓国語の公的機関 PDF 報告書の正解根拠ラベルで LoRA アダプタのみを学習しました。

**本アダプタは韓国語に特化しています。** 韓国語の文書のみで学習し、韓国語でのみ検証したため、
他の言語での挙動は分かりません。
...
檀国大学校 **情報融合技術・創業大学院 IT コンバージェンス学科**（정보융합기술·창업대학원
IT컨버전스학과）にて学習・公開しました。
大学院 <https://cms.dankook.ac.kr/web/gict> ・ 学科 <https://cms.dankook.ac.kr/web/gict/it-2>
